...
Release archives include `custom_analyzers/`, the built-in project templates in
`templates/`, and `scripts/verify-release-payload.py` for running the packaged
Camel analyzer self-tests.
